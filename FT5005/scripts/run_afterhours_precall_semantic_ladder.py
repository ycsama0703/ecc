...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run after-hours pre-call semantic ladders around A4 and Q&A semantics."
    )
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("results/afterhours_precall_semantic_ladder_real"),
    )
...
def main() -> None:
    ...
    comparisons = [
        ...
        ("residual_pre_call_market_only", "residual_pre_call_market_plus_a4"),
        ("residual_pre_call_market_plus_a4", "residual_pre_call_market_plus_a4_plus_qna_lsa"),
        ("residual_pre_call_market_only", "residual_pre_call_market_plus_controls"),
        (
    ...
    write_json(output_dir / "afterhours_precall_semantic_ladder_summary.json", summary)
    write_csv(output_dir / "afterhours_precall_semantic_ladder_predictions.csv", prediction_rows)
